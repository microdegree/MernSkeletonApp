...
var CorporateController = require('./controller/AdminController');
app.use('/api/admin', CorporateController);

var ConsumerController = require('./controller/ConsumerController');
app.use('/api/consumer', ConsumerController);
